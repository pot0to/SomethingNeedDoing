-- This is a small script that I made (and thank you Rhalgar for fixing that last jump that was finikcy)
-- This is meant to climb up to the top from the bottom of Kugane
-- THIS ISN'T PERFECT, AND Like...1/10 times will fail (maybe 2/10)
-- But if you're using this. Either you're bored, or just need some... help
-- From Ice/Rhalgar
