...
for i=1,#charlist do
	...
	if IsAetheryteUnlocked(12) == false then
		...
		yield("/vnav "..movetype.." 572.73193359375 96.397186279297 -525.09948730469") --get to eastern las noscnea wineport side
		visland_stop_moving()
		CharacterSafeWait()
	...
	yield("/vnav "..movetype.." 80.876075744629 80.039474487305 -125.75521850586") --get to bronze lake
	visland_stop_moving()
	CharacterSafeWait()
	...
	yield("/vnav "..movetype.." 286.96008300781 41.385322570801 -203.57307434082") --get to upper la noscea
	visland_stop_moving()
	CharacterSafeWait()
